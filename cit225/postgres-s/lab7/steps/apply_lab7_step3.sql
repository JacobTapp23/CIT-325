-- ------------------------------------------------------------------
--  Program Name:   apply_lab7_step3.sql
...
--
--   psql> \i apply_lab7_step3.sql
--
-- ------------------------------------------------------------------

-- ------------------------------------------------------------------
--  Task #1: Resolve the WHERE clause logic.
--  Task #2: Resolve the start_date logic.
--  Task #3: Resolve the end_date logic.
--  Task #4: Resolve the amount logic with nested CASE statement.
-- -------------------------------------------------------------------
