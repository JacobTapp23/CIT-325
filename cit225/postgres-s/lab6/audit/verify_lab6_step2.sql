...
-- Query label.
SELECT 'Lab 6: Step 2: Task 1(a)' AS "Task Identifier";
...
-- Query label.
SELECT 'Lab 6: Step 2: Task 1(b)' AS "Task Identifier";
...
AND      conrelid::regclass::text = current_setting('videodb.table_name')
ORDER BY conrelid::regclass::text
,        conname;

-- Query label.
SELECT 'Lab 6: Step 2: Task 2' AS "Task Identifier";
