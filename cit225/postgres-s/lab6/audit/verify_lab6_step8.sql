-- ------------------------------------------------------------------
--  Program Name:   verify_lab6_step8.sql
--  Lab Assignment: N/A
...
DROP INDEX IF EXISTS uq_price_u1;

-- Create unique index on the system user name.
CREATE UNIQUE INDEX uq_price_u1
  ON price (item_id, price_type, active_flag, start_date, amount);
