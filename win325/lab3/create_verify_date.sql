...
SELECT verify_date('01-JAN-2008') AS result FROM dual;
SELECT verify_date('29-FEB-2008') AS result FROM dual;
SELECT verify_date('29-FEB-2009') AS result FROM dual;
