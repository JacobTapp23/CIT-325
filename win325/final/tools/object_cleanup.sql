...
BEGIN
  ...
  FOR i IN 1..lv_list.COUNT LOOP
    ...
    dbms_output.put_line('Debug X ... ['||i||']');
    FOR j IN get_object(lv_list(i)) LOOP
    dbms_output.put_line('Debug A ... ['||j.object_name||']');
...
select type_name, supertype_name from user_types;
...
BEGIN
  FOR i IN (SELECT o.object_name
    ...
    dbms_output.put_line('Debug ... ['||i.object_name||']');
