...
DECLARE
  ...
  */
  ...
  /* The difference here is that we assign four values when we construct
  ...
  */
  lv_mime   LIST := list('Partridge'||CHR(10),'Turtle Doves','French Hen','Calling Birds','Gold Rings');
BEGIN
