...
/* Setup environment.
@/home/student/Data/cit325/lab1/apply_plsql_lab9.sql
@/home/student/Data/cit325/lab11/tools/base_t_ots.sql
@/home/student/Data/cit325/lab11/tools/base_t_otb.sql
...
BEGIN
  FOR i IN (SELECT uo.object_name
            ...
            WHERE  uo.object_name IN ('LOGGING','LOGGING_S')) LOOP
...
CREATE OR REPLACE
  ...
  /* This version handles only insert events. */
  ...
  /* This version is capable of handling insert, update, and delete events,
     which means the program logic should only exist in this version of
  ...
  /* This version handles only delete events. */
  PROCEDURE avenger_insert
    ( PV_OLD_ITEM_ID            NUMBER                  
    , PV_OLD_ITEM_BARCODE       VARCHAR2
    , PV_OLD_ITEM_TYPE          NUMBER                  
